...
const Div = styled.div`
  min-height: 85vh;
`
const Articles: NextPage<{ docs: metaArticles[] }> = ({ docs }) => {
  ...
  return (
    <Div className="container">
      <ListTags className="pb-6 pt-4" allTags={allTags} directory="articles" />
      <ListArticlesContainer className="pb-6 pt-4">
        <ListArticles docs={selectedDocs} directory="articles" />
