...
const Codes: NextPage<{ docs: metaArticles[] }> = ({ docs }) => {
  ...
  return (
    <Div className="container">
      <ListTags className="pb-6 pt-4" allTags={allTags} directory="inspirations" />
      <ListArticlesContainer className="pb-6 pt-4">
        <ListArticles docs={selectedDocs} directory="inspirations" />
...
export async function getStaticProps() {
  const docs = getAllArticlesByDirectory("inspirations")
  return {
    props: { docs },
  }
}
